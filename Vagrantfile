...
$my_box_url          = "http://fuerstnet.de/vagrant_boxes/#{$my_box}-virtualbox.box" unless defined? $my_box_url
$my_box_url_vmware   = "http://fuerstnet.de/vagrant_boxes/#{$my_box}-vmware-fusion.box" unless defined? $my_box_url_vmware
